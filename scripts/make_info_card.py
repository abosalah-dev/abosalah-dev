...
# ===========================================================================
HOST = "ahmed"   # shown as  ahmed@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Tech Support Head & Dev @ Amancom"),
    ("kv", "Building", "GPS fleet platform, 11k+ devices"),
    ("kv", "Also", "Head of Coordination @ MSA CPC"),
    ("kv", "Edu", "B.Sc. CS @ MSA '27, GPA 3.55/4.0"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "PHP, Python, C++, Java, C#, TS"),
    ("kv", "Backend", "Laravel, OOP, REST APIs"),
    ("kv", "Data", "MySQL, Odoo"),
    ("kv", "Tools", "Git, Linux, AT Commands"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Config tool for 11,000+ GPS devices"),
    ("bul", "AlgoLab visualizer used at MSA"),
    ("bul", "ACPC '24 & '25 competitive programmer"),
]
